...
const rawChannels = [
    ...
    { id: '24h-simpsons', name: '24h Simpsons', url: 'https://canais.fazoeli.co.za/fontes/smart/24h_simpsons.m3u8', category: 'Infantil', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/98/The_Simpsons_yellow_logo.svg/1200px-The_Simpsons_yellow_logo.svg.png' },
    { id: '24h-dragonball', name: '24h Dragon Ball', url: 'https://canais.fazoeli.co.za/fontes/smart/24h_dragonball.m3u8', category: 'Infantil', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/ca/Dragon_Ball_Z_Logo_A.png/640px-Dragon_Ball_Z_Logo_A.png' },
    { id: '24h-odeia-chris', name: '24h Todo Mundo Odeia o Chris', url: 'https://canais.fazoeli.co.za/fontes/smart/24h_odeiachris.m3u8', category: 'Infantil', logo: 'https://upload.wikimedia.org/wikipedia/pt/b/b5/Todo_Mundo_Odeia_o_Chris.jpg' },
    ...
    { id: 'despertar-tv', name: 'Despertar TV', url: 'https://cdn.live.br1.jmvstream.com/webtv/pejexypz/playlist/playlist.m3u8', category: 'TV Aberta', logo: 'https://despertar.tv/wp-content/uploads/2021/08/logo-despertar-tv.png' },
    ...
    { id: '4k-travel', name: '4K Travel TV', url: 'https://streams2.sofast.tv/sofastplayout/33c31ac4-51fa-46ae-afd0-0d1fe5e60a80_0_HLS/master.m3u8', category: 'Internacionais', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c4/Travel_Channel_logo.svg/512px-Travel_Channel_logo.svg.png' },
    { id: 'destination-tv', name: 'Destination TV', url: 'http://media4.tripsmarter.com:1935/LiveTV/DTVHD/playlist.m3u8', category: 'Internacionais', logo: 'https://upload.wikimedia.org/wikipedia/commons/8/82/Destination_America_logo.png' },
    { id: 'movie-channel', name: 'The Movie Channel', url: 'https://streams2.sofast.tv/sofastplayout/32eb332e-f644-46e5-ad91-e55ad80d14f7_0_HLS/master.m3u8', category: 'Internacionais', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1d/The_Movie_Channel_logo.svg/512px-The_Movie_Channel_logo.svg.png' },
